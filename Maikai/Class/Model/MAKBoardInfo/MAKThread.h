...
@interface MAKThread : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) NSArray *lastReplies;
@property (nonatomic, strong) NSString *sub;
@property (nonatomic, assign) double omittedImages;
...
@property (nonatomic, assign) double no;
@property (nonatomic, assign) double omittedPosts;
